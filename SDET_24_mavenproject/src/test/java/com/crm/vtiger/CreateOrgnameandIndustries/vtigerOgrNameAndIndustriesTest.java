...
public class vtigerOgrNameAndIndustriesTest {

	@Test
		 
			public void CreateIndustriesTest() throws Throwable {
			Random r=new Random();
			...
			driver.findElement(By.name("accountname")).sendKeys(org+""+ranger);
